      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-6 lg:px-12">
        <Link href="/" aria-label="Amazon Safety Pro" className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-blue-600">
            <span className="text-[12px] font-black text-white">SP</span>
          </div>
            ...
            return (
              <Link
                ...
                className={`rounded-lg px-3 py-2 text-[14px] font-medium transition-colors ${
                  active ? "bg-blue-50 text-blue-600" : "text-slate-600 hover:text-slate-900"
                }`}
              >
                {link.label}
              </Link>
        ...
        <div className="hidden xl:block">
          <Link
            ...
            className="inline-flex cursor-pointer items-center rounded-xl bg-blue-600 px-5 py-2.5 text-[13px] font-semibold text-white shadow-sm transition-all hover:bg-blue-500"
          >
            Free Review
          </Link>
        </div>
            ...
            <div className="space-y-1 px-6 py-6">
              {NAV_LINKS.map((link) => (
                <Link
                  ...
                  className="block rounded-lg px-3 py-3 text-[14px] font-medium text-slate-600 hover:bg-slate-50 hover:text-slate-900"
                >
                  {link.label}
                </Link>
              ))}
              <div className="pt-4">
                <Link
                  href="/free-validation"
                  className="block rounded-xl bg-blue-600 py-3 text-center text-[14px] font-semibold text-white"
                >
                  Free Review
                </Link>
              </div>
